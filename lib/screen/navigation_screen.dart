...
import 'package:shinhanapp/screen/my_page_screen.dart';
...
class _NavigationScreenState extends State<NavigationScreen> {
  ...
  void initState() {
    ...
    _widgetList = [
      ...
      LessonApplyScreen(key: _navigatorKeys[1],),
      MyPageScreen(key: _navigatorKeys[2],),
    ];
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        if (await _navigatorKeys[selectedIndex].currentState!.maybePop()) {
          return false;
        }
        return _onWillPop();
      },
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
            items: [
              ...
              BottomNavigationBarItem(
                icon: ImageIcon(
                  AssetImage("assets/navigation/navigation_study_image.png"),
                ),
                label: "수강신청",
              ),
              BottomNavigationBarItem(
