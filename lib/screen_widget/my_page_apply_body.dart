...
import 'my_page_lecture_list_head.dart';
import 'my_page_lecture_list_items.dart';

class MyPageApplyBody extends StatelessWidget {
  const MyPageApplyBody({
    Key? key,
  }) : super(key: key);

  @override
  Widget build(BuildContext context) {
    print("빌드 : MyPageApplyBody");
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemCount: int.tryParse(provider.applyCount),
                    ),
                  ),
                ],
              ),
