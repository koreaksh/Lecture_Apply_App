...
class MyPageStudyingBody extends StatelessWidget {
  const MyPageStudyingBody({
    Key? key,
  }) : super(key: key);
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemCount: int.tryParse(provider.studyIngCount),
                    ),
                  ),
                ],
              ),
